...
# Based on https://github.com/acl21/Webcam_Paint_OpenCV
# Tutorial at https://towardsdatascience.com/tutorial-webcam-paint-opencv-dbe356ab5d6c
...
# Define the upper and lower boundaries for a color to be tracked
track_colour_lower = np.array([100, 60, 60])
track_colour_upper = np.array([140, 255, 255])
...
while True:
    ...
    blueMask = cv2.inRange(hsv, track_colour_lower, track_colour_upper)
